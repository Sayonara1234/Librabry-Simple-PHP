...
<div class="tabs">
    <a href="list_buku.php" class="tab active">List Buku</a>
    ...
    <table>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<td>" . $row['stok'] . "</td>";
            // Menambahkan link untuk peminjaman secara langsung
            echo "<td><a href='pinjam.php?id_buku=" . $row['id_buku'] . "'>Pinjam</a></td>";
            echo "</tr>";
            $no++;
        }
        ?>
